...
Matriz Sólida: Comienzo con un bloque lleno de muros (#).

Túnel Seguro: Garantizo una ruta de escape desde (0,0) hasta el final mediante un camino aleatorio forzado.

Azar: Rompo un 40% de los muros restantes para crear bifurcaciones y rutas alternativas.
